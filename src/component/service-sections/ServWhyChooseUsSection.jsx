...
const ServWhyChooseUsSection = ({ data }) => {
  console.log("ServWhyChooseUsSection data:", data);

  // Extract data with fallbacks
  const {
    batch = "WHY CHOOSE US",
    title = "Why Thousands Trust",
    highlighted_title = "SWC Global",
    description = "We provide trusted immigration advice, strategic guidance, and end-to-end support to help individuals, families, and businesses achieve their immigration goals with confidence.",
    cards = [],
  } = data || {};
  ...
  // Use cards from API or fallback to empty array
  ...
  // Default descriptions for cards that don't have one
  const getDefaultDescription = (title) => {
    const defaults = {
      "Trusted Immigration Experts": "Our specialists stay up-to-date with the latest immigration laws and policies to provide accurate guidance.",
      "High Success Rate": "We carefully prepare every application to maximize approval chances and reduce delays.",
      "Personalized Support": "Every client receives tailored advice and a strategy designed around their unique circumstances.",
      "Fast & Efficient Service": "We streamline the application process and keep you informed at every stage.",
      "Dedicated Case Management": "A dedicated advisor will guide you through your journey and answer your questions promptly.",
      "Business & Personal Solutions": "From sponsor licences to family visas, we provide complete immigration solutions.",
    };
    return defaults[title] || "We provide expert guidance and support for all your immigration needs.";
  };
          ...
          <>
            ...
            >
              {features.map((item, index) => {
                ...
                const cardDescription = item.description || getDefaultDescription(item.title);
