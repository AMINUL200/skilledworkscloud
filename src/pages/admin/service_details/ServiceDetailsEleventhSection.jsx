...
import { Save, Plus, Edit, Trash2, X, Layers, Shield, Award, Users, Clock, Headphones, Briefcase, Heart } from 'lucide-react';

const ServiceDetailsEleventhSection = () => {
  ...
  const fetchSections = async () => {
    try {
      ...
      const response = await api.get('/admin/sv-eleventh-section/list');
  ...
  const handleDelete = async (id) => {
    ...
    try {
      setLoading(true);
      const response = await api.delete(`/admin/sv-eleventh-section/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingSection) {
        ...
        response = await api.post('/admin/sv-eleventh-section/save', submitData, {
          headers: {
          ...
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-semibold text-gray-800 flex items-center gap-2">
                ...
                Service Details Eleventh Section
              </h2>
              <p className="text-sm text-gray-600">Manage service details why choose us section</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          {!showForm && (
            <button
              ...
              className="px-4 py-2 bg-pink-600 text-white rounded-md hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-pink-500 flex items-center gap-2 transition-colors"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  placeholder="e.g., service_eleventh_section"
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent"
                  required
                  disabled={saving}
                />
                <p className="text-xs text-gray-500 mt-1">
                  Unique identifier for this section (e.g., service_eleventh_section)
                </p>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleCardChange}
                      placeholder="e.g., Trusted Immigration Experts"
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent"
                      disabled={saving}
                    />
                  </div>
                  ...
                  {editingCardIndex !== null ? (
                    <>
                      <button
                        ...
                        className="px-4 py-2 bg-pink-600 text-white rounded-md hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-pink-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                        disabled={saving}
                      >
                        Update Card
                      </button>
            ...
            <div className="flex flex-wrap gap-4 pt-4 border-t border-gray-200">
              <button
                type="submit"
                disabled={saving}
                className="px-6 py-2 bg-pink-600 text-white rounded-md hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-pink-500 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 transition-colors"
              >
                {saving ? (
                  <>
            ...
            {sections.length === 0 ? (
              ...
              <div className="grid grid-cols-1 gap-4">
                {sections.map((section) => (
                  <div
                    key={section.id}
                    className="bg-gradient-to-br from-pink-50 to-rose-50 border border-pink-200 rounded-lg p-6 hover:shadow-md transition-shadow"
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        {section.batch && (
                          <p className="text-sm text-pink-600 font-medium">{section.batch}</p>
                        )}
                        
                        <h3 className="text-xl font-semibold text-gray-800 mt-1">
                          {section.title}
                          {section.highlighted_title && (
                            <span className="text-pink-600"> {section.highlighted_title}</span>
                          )}
                        </h3>
...
export default ServiceDetailsEleventhSection;