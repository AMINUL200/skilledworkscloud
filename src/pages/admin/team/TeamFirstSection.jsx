...
import { Save, RefreshCw, Upload, X, Image, Eye } from 'lucide-react';

const TeamFirstSection = () => {
  ...
  const fetchSectionData = async () => {
    try {
      ...
      const response = await api.get('/admin/team-first-section');
      ...
      console.error('Error fetching team first section:', error);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await api.post('/admin/team-first-section/save', submitData, {
        headers: {
      ...
      if (response.data.status) {
        setMessage({
          type: 'success',
          text: response.data.message || 'Team first section saved successfully!'
        });
      ...
      console.error('Error saving team first section:', error);
    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden">
      <div className="px-6 py-4 bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-gray-200">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-xl font-semibold text-gray-800">Section 1: Team Header</h2>
            <p className="text-sm text-gray-600">Manage the main team section header and call-to-action buttons</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              placeholder="Additional title meta"
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              disabled={saving}
            />
          </div>
